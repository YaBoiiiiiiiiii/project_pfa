...
let update _ el =
  (*Initialisation : All items are not in contact of any other items*)
  Seq.iter (fun e -> 
    e#isInContact#set false; 
    ) el;
  ...
  |> iter_pairs (fun (e1:t) (e2:t) ->
      ...
      if Float.is_finite m1 || Float.is_finite m2 then begin
        ...
        if Rect.has_origin pdiff rdiff then begin
          ...
          (*These items  were in contact : set isInContact to true for this game loop*)
          e1#isInContact#set true; 
          e2#isInContact#set true; 
